...
class Carousel {
    ...
    setControls() {
        this.carouselControls.forEach((control) => {
            ...
            ).className = `gallery-controls-${control} btn`
        })
    ...
    useControls() {
        ...
        triggers.forEach((control) => {
            control.addEventListener("click", () => {
                ...
                const nextLeftCarouselItem = document.querySelectorAll(
                    ".gallery-item-next-left"
                )
                const nextRightCarouselItem = document.querySelectorAll(
                    ".gallery-item-next-right"
                )
                ...
                this.setCurrentState(
                    ...
                    leftSelectedItem,
                    rightSelectedItem,
                    nextLeftCarouselItem,
                    nextRightCarouselItem
                )
            })
        })
    }
