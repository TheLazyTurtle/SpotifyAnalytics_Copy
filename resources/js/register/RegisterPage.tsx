...
import PrivacyComponent from "../Privacy/PrivacyPage";
            ...
            <div className="text-center login-wrapper mt-sm-0">
                <div className="mx-auto col-sm-3 py-3 bg-white rounded-8">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-outline">
                            <input className="mt-1 mx-2 bg-custom-gray" type="checkbox" name="acceptPrivacy" placeholder="Accept privacy" onChange={handleChange} />I accept the terms of service. Read them <span className="text-custom-green" onClick={() => setShowPrivacy(true)}>here</span> <br />
